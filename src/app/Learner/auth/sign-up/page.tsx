    ...
    <main className="w-full h-screen flex justify-center items-center">
      <Card className="min-w-80 border-0 shadow-white">
        <CardHeader>
          ...
          <CardDescription>Welcome to New Learning World.</CardDescription>
        </CardHeader>
        <CardContent>
          <form>
        ...
        <Link href='/Learner/auth/verify' className="w-full"><Button className="w-full ">Submit</Button></Link>
          <div className="w-full flex justify-center items-center gap-3 my-4">
            <Separator className="w-28" />
            <p className="text-zinc-600">or</p>
            <Separator className="w-28" />
          </div>
          <Link href="/Learner/auth/sign-in" className="w-full">
